...
<br><br>
<center>
	<b><u><h1 style="color: black"> DOCTOR REGISTRATION</h1></u></b><br>
<form  enctype="multipart/form-data" method="post">
	<table>
		...
		<!-- <tr>
			<td style="color: white;">Experiance</td><td><input type="text" name="exp" class="form-control"  style="margin-bottom: 8px;margin-left: 8px" required></td>
		</tr> -->
		<tr>
		...
		<!-- <tr>
			<td style="color: black;">Picture:</td><td> <input type="file" name="photo" required></td> -->
...
//     }
	...
	$q="INSERT into login(email,password,status,user) values('$email','$password','0','doctor')";
	// echo $q;
	if(mysql_query($q,$conn))
	{
		$id=0;
			...
			$q2="INSERT INTO dreg(name, email, address, spec, loginid) values('$name','$email','$address','$spec','$id')";
