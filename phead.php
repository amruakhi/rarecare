        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
              <a class="nav-link" href="phome.php">Home</a>
            </li>
            <!-- <li class="nav-item">
              <a class="nav-link" href="#.php">Doctors</a>
            </li> -->
            <div class="dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="pbook.php">Book Appointment</a>
                <a class="dropdown-item" href="pmybook.php">My Bookings</a>
              </div>
            </div>

            <li class="nav-item">
              <a class="nav-link" href  ="pdonation.php">Ask Donation</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href  ="phisdonation.php">Donation History</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="pprofile.php">Update Profile</a>
            </li>
            <li class="nav-item">
