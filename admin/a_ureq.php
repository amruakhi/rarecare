...
<div class="page-header">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">New Doctors</h5>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">New Doctors</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
   ...
   <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Doctor Requests</h3>
        <div class="row mb">
          <!-- page start-->
        ...
        customer.loginid=login.lid and login.status='0' and login.user='hospital'");
              // echo $result;
