...
<div class="page-header">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Rejected Doctors</h5>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Rejected Doctors</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
   ...
   <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Rejected Companies</h3>
        <div class="row mb">
          <!-- page start-->
    ...
    <!-- <div class="row">
      <div class="col-xl-10">
        ...
        customer.loginid=login.lid and login.status='2' and login.user='hospital'");
               echo $result;
