...
<center>
	<b><u><h1 style="color: black">HOSPITAL REGISTRATION</h1></u></b><br><br>
<form method="POST">
	<table>
		<tr>
		...
		<tr>
			<td>Password </td><td><input type="password" name="password" class="form-control" style="margin-bottom: 8px;margin-left: 8px" 
					pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" 
...
if(isset($_POST['submit'])){
	...
	$q="INSERT into login(email,password,status,user) values('$email','$password','0','hospital')";
	// echo $q;
